using BHF.MS.test18.Database.Context;
using BHF.MS.test18.Database.Services;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.DependencyInjection;
using System.Diagnostics.CodeAnalysis;

namespace BHF.MS.test18.Database
{
    ...
    public static class DependencyInjectionInitializers
    {
        public static void AddDatabases(IServiceCollection serviceCollection)
        {
            ...
            {
                options.UseSqlServer("name=ConnectionStrings:Dbtest18");
            });
        }
