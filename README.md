...
* Copy code\BHF.MS.test18\yaml\configMap-development.yml.example as "configMap-development.yml"
...
* Every single migration command requires Args parameter containing full query string to the databse, sample command below:
	* Add-Migration InitialMigration -Context CustomDbContext -Project BHF.MS.test18.Database -StartupProject BHF.MS.test18.Database -Args "Data Source=(local);Initial Catalog=test18;User ID=[user];Password=[passwsord];Trust Server Certificate=True"
